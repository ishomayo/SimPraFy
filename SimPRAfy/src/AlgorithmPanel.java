...
public class AlgorithmPanel extends JPanel {
    ...
    private void updateUI(int page, boolean isHit) {
        ...
        columnPanel.setPreferredSize(new Dimension(columnWidth, 375));
        columnPanel.setMaximumSize(new Dimension(columnWidth, 375));
        columnPanel.setMinimumSize(new Dimension(columnWidth, 375));
